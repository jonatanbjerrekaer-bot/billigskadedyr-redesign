/**
 * Articles from billigskadedyr.dk, pulled from their own WordPress REST API
 * (/wp-json/wp/v2/posts). Titles and opening text are theirs, reproduced as-is
 * for this concept; each entry links back to the original.
 *
 * Scraping the rendered pages does not work: every article's HTML returns the
 * same nav markup, so the body has to come from the API.
 *
 * Generated 13 entries.
 */
export type Article = { slug: string; title: string; url: string; intro: string };
...
export const ARTICLES: Article[] = [
  ...
  {
    slug: "hvordan-finder-man-en-rotterede",
    title: "Hvordan finder man en rotterede?",
    url: "https://billigskadedyr.dk/hvordan-finder-man-en-rotterede/",
    intro:
      "Rotter er et af de mest problematiske skadedyr, man kan få i og omkring sin bolig, og det kan derfor være vigtigt at finde deres rotterede. De kan ødelægge bygninger, gnave i ledninger og sprede bakterier gennem urin og ekskrementer. Når rotter først etablerer sig i et område, vil de ofte bygge en rede i nærheden af føde og skjul. Derfor er det afgørende at finde rottereden, hvis man vil bekæmpe problemet effektivt.",
  },
  {
    slug: "saadan-slipper-du-af-med-mus-i-huset",
    title: "Sådan slipper du af med mus i huset",
    url: "https://billigskadedyr.dk/saadan-slipper-du-af-med-mus-i-huset/",
    intro:
      "Mus i huset er et almindeligt problem i mange danske hjem, især i efteråret og vinteren, hvor de små gnavere søger ind i varme bygninger med adgang til føde og skjulesteder. Selvom gnaverne kan virke harmløse ved første øjekast, kan de hurtigt skabe store problemer i hjemmet. De kan gnave i isolering, ledninger og fødevarer, og deres ekskrementer kan forurene køkkenskabe og opbevaringsområder.",
  },
  {
    slug: "musefaelder-hvilken-virker-bedst",
    title: "Musefælder – hvilken virker bedst?",
    url: "https://billigskadedyr.dk/musefaelder-hvilken-virker-bedst/",
    intro:
      "Mus i huset er et problem mange boligejere oplever, især i efteråret og vinteren, hvor gnavere søger ind i varme bygninger med adgang til føde og skjulesteder. Når mus først er kommet ind, kan de hurtigt skabe problemer ved at gnave i isolering, træværk, fødevarer og i værste fald elektriske installationer. Samtidig kan de sprede bakterier via ekskrementer og urin, hvilket gør det vigtigt at reagere hurtigt.",
  },
  {
  ...
  {
    slug: "har-jeg-skaegkrae-guide-til-monitorering",
    title: "Har jeg skægkræ? – Guide til monitorering",
    url: "https://billigskadedyr.dk/har-jeg-skaegkrae-guide-til-monitorering/",
    intro:
      "Skægkræ er blevet et af de mest almindelige skadedyr i danske boliger, og mange opdager først problemet, når de ser et hurtigt insekt løbe hen over gulvet om aftenen. Men hvordan ved man egentlig, om det er skægkræ eller sølvfisk? Og hvordan finder man ud af, hvor stort problemet er?",
  },
  {
