import { BadgeCheck, Clock, PhoneCall, Tag } from "lucide-react";
...
const USPS = [
  ...
  { Icon: BadgeCheck, label: "e-mærket webshop", text: "Din tryghed er essentiel" },
];

export default function UspBar() {
  return (
    <div className="bg-ink-950 text-ink-100/80 border-b border-ink-800">
      <div className="max-w-[1600px] mx-auto px-5 sm:px-8 py-2.5 sm:py-3 grid grid-cols-2 lg:grid-cols-4 gap-x-4 sm:gap-x-6 gap-y-2">
